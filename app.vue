...
<template>
  <NuxtExample dir="advanced/error-handling" current-route>
    <template #nav>
      ...
      <button class="n-link-base" @click="() => showError('Fatal error')">Trigger fatal error</button>
      <button class="n-link-base" @click="triggerError">Trigger non-fatal button</button>
    </template>
    <NuxtPage />
  </NuxtExample>
</template>
